...
<xsl:stylesheet version="1.0"
    ...
    <importantfields>
      ...
      <source type="Misc">
       ...
       <source type="Film">
        ...
        <b:ImportantField>b:Writer</b:ImportantField>
        <b:ImportantField>b:CountryRegion</b:ImportantField>
        <b:ImportantField>b:Year</b:ImportantField>
       </source>
       <source type="SoundRecording">
        <b:ImportantField>b:Performer</b:ImportantField>
        <b:ImportantField>b:Title</b:ImportantField>
    ...
    <bibliography>
      ...
      <source type="Report">
        <column id="1">
          <halign>left</halign>
          <valign>top</valign>
          <format>{%RefOrder%. }{%Author:1%, }{"%Title%," }{%Department%, }{%Institution%, }{%City|StateProvince|CountryRegion%, }{%StateProvince|CountryRegion%, }{%CountryRegion%, }{%ThesisType% }{%StandardNumber%, }{{%Month:s%{ %Day%,}} %Year%}.{ [Online]. %URL:l%}</format>
        </column>
      </source>
      <source type="InternetSite">
        <column id="1">
      ...
      <source type="Patent">
        <column id="1">
          <halign>left</halign>
          <valign>top</valign>
          <format>{%RefOrder%. }{%Inventor:1|Author:1%, }{"%Title%,"}{ %Type%}{ %PatentNumber%}{,{ %Month:s%{ %Day%,}} %Year%}.</format>
        </column>
      </source>
      <source type="Misc">
        <column id="1">
          <halign>left</halign>
          <valign>top</valign>
          <format>{%RefOrder%. }{%Comments%}.</format>
        </column>
      </source>
      <source type="Standard">
        <column id="1">
          <halign>left</halign>
          <valign>top</valign>
          <format>{%RefOrder%. }{%Author:1%, }{"%Title%," }{%Institution%, }{%ThesisType% }{%StandardNumber%}{,{ %Month:s%} %Year%}.{ [Online]. %URL:l%}</format>
        </column>
      </source>
      <source type="Thesis">
        <column id="1">
          <halign>left</halign>
          <valign>top</valign>
          <format>{%RefOrder%. }{%Author:1%, }{"%Title%," }{%ThesisType%, }{%Institution%, }{%City|StateProvince|CountryRegion%}{, %StateProvince|CountryRegion%}{, %CountryRegion%}{, %Year%}.{ [Online]. %URL:l%}</format>
        </column>
      </source>
      <source type="Film">
        <column id="1">
  ...
  <xsl:template match="/">
    ...
    <xsl:choose>
      ...
      <xsl:when test="b:StyleName">
       ...
       <xsl:text>ГОСТ 7.0.5-2008</xsl:text>
      </xsl:when>
  ...
  <xsl:template name="format-bibliography-as-table">
    ...
    <p class="MsoBibliography" style="display:none;"/>
